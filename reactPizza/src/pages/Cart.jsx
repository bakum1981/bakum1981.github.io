...
import {clearCart, minusItem, plusItem, removePizza} from "../redux/cartReducer";
...
const Cart = () => {
    ...
    const onClearCart = () => {
        if (window.confirm('Вы уверены, что хотите корзину?')) {
            dispatch(clearCart());
        }
    }
    ...
    return (
        <div className="content">
            {totalPrice ? <div className="container container--cart">
                <div className="cart">
                    ...
                    <div className="content__items">
                        {addedPizzas.map(obj => <CartItem key={obj.id} name={obj.name} imageUrl={obj.imageUrl}
                                                          type={obj.type} size={obj.size} id={obj.id}
