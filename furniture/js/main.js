$(function () {
	...
	const trigger = document.querySelectorAll('.header__item')[1] 
	...
	document.addEventListener('click', function(e){
		...
		if(!target.classList.contains('header__submenu') && !target.closest('.header__item') && document.querySelectorAll('.header__item.active').length > 0){
			submenu.classList.remove('active')
			trigger.classList.remove('active')
		}else if (target.closest('.header__submenu')){
